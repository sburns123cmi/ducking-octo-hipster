...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { bio: @speaker.bio, name: @speaker.name, organization: @speaker.organization, title: @speaker.title }
    end
  ...
  test "should update speaker" do
    put :update, id: @speaker, speaker: { bio: @speaker.bio, name: @speaker.name, organization: @speaker.organization, title: @speaker.title }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
