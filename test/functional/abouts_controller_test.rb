...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { description: @about.description, producer_email: @about.producer_email, producer_name: @about.producer_name, producer_title: @about.producer_title, title: @about.title }
    end
  ...
  test "should update about" do
    put :update, id: @about, about: { description: @about.description, producer_email: @about.producer_email, producer_name: @about.producer_name, producer_title: @about.producer_title, title: @about.title }
    assert_redirected_to about_path(assigns(:about))
  end
